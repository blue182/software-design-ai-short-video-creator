...
function SelectVoice({ onUserSelect, selected, hasError }) {
    ...
    return (
        <div>
            <h2 className="font-bold text-primary text-base sm:text-base md:text-lg lg:text-xl">Voice</h2>
            <p className="text-sm sm:text-sm md:text-base text-gray-500 mb-2">Select the voice for your video</p>
            ...
            {loading ? (
                ...
                <Select
                    ...
                    <SelectTrigger
                        className={`w-full mt-2 p-6 text-sm sm:text-base md:text-base lg:text-lg border ${hasError ? 'border-red-500' : 'border-gray-300'}`}
